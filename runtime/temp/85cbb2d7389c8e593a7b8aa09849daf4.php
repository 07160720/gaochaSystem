<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"D:\wwwroot\sysnaica\wwwroot\agaocha\public/../application/admin\view\support\lst.htm";i:1533795186;s:83:"D:\wwwroot\sysnaica\wwwroot\agaocha\public/../application/admin\view\common\top.htm";i:1533881065;s:84:"D:\wwwroot\sysnaica\wwwroot\agaocha\public/../application/admin\view\common\left.htm";i:1533795181;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
            ...
            <div class="page-content">
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">加盟支持管理</li>
                    </ul>
                </div>
                <div class="page-body">
                    <button type="button" tooltip="添加加盟支持" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('support/add'); ?>'"> <i class="fa fa-plus"></i> Add
                    </button>
                    <div class="row">
                                        ...
                                        <table class="table table-bordered table-hover">
                                            <thead class="">
                                                <tr>
                                                    ...
                                                    <th class="text-center">开业前描述</th>
                                                    <th class="text-center">开业中描述</th>
                                                    <th class="text-center">开业后描述</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center"><?php echo $vo['desc1']; ?></td>
                                                    <td align="center"><?php echo $vo['desc2']; ?></td>
                                                    <td align="center"><?php echo $vo['desc3']; ?></td>
                                                    <td align="center">
                                                        <a href="<?php echo url('support/edit',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                                            <i class="fa fa-edit"></i> 编辑
                                                        </a>
                                                        <a href="#" onClick="warning('确实要删除吗', '<?php echo url('support/del',array('id'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny">
