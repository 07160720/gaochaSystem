<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"D:\PhpStudy\PHPTutorial\WWW\agaocha\public/../application/admin\view\produce\lst.htm";i:1533900332;s:83:"D:\PhpStudy\PHPTutorial\WWW\agaocha\public/../application/admin\view\common\top.htm";i:1533900335;s:84:"D:\PhpStudy\PHPTutorial\WWW\agaocha\public/../application/admin\view\common\left.htm";i:1533900335;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
            ...
            <div class="page-content">
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">产品展示管理</li>
                    </ul>
                </div>
                <div class="page-body">
                    <button type="button" tooltip="添加文章" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('produce/add'); ?>'"> <i class="fa fa-plus"></i> Add
                    </button>
                    <div class="row">
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <img src="__IMG__<?php echo $vo['pic']; ?>" style="width: 150px;height: 150px;">
                                                    </td>
                                                    <td align="center">
                                                        <a href="<?php echo url('produce/edit',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                                            <i class="fa fa-edit"></i> 编辑
                                                        </a>
                                                        <a href="#" onClick="warning('确实要删除吗', '<?php echo url('produce/del',array('id'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny">
