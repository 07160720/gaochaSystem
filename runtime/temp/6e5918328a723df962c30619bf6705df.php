<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"D:\wwwroot\sysnaica\wwwroot\agaocha\public/../application/admin\view\successful\lst.htm";i:1533893069;s:83:"D:\wwwroot\sysnaica\wwwroot\agaocha\public/../application/admin\view\common\top.htm";i:1533881065;s:84:"D:\wwwroot\sysnaica\wwwroot\agaocha\public/../application/admin\view\common\left.htm";i:1533795181;}*/ ?>
<!DOCTYPE html>
<html><head>
	<meta charset="utf-8">
    <title>链接列表</title>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">成功案例管理</li>
                    </ul>
                </div>
                <div class="page-body">

                    <button type="button" tooltip="添加案例" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('successful/add'); ?>'"> <i class="fa fa-plus"></i> Add
                    </button>
                    <div class="row">
                                        ...
                                        <table class="table table-bordered table-hover">
                                            <thead class="">
                                                <tr>
                                                    ...
                                                    <th class="text-center" width="8%">案例标题</th>
                                                    <th class="text-center" width="8%">关键字</th>
                                                    <th class="text-center" width="10%">案例描述</th>
                                                    <th class="text-center">案例内容</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <a href="<?php echo url('successful/edit',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                                            <i class="fa fa-edit"></i> 编辑
                                                        </a>
                                                        <a href="#" onClick="warning('确实要删除吗', '<?php echo url('successful/del',array('id'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny">
