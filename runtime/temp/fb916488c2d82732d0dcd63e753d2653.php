<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"D:\wwwroot\sysnaica\wwwroot\agaocha\public/../application/admin\view\headquarters\add.htm";i:1533795182;s:83:"D:\wwwroot\sysnaica\wwwroot\agaocha\public/../application/admin\view\common\top.htm";i:1533795181;s:84:"D:\wwwroot\sysnaica\wwwroot\agaocha\public/../application/admin\view\common\left.htm";i:1533795181;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo url('headquarters/lst'); ?>">搞茶总部管理</a>
                        </li>
                        <li class="active">添加搞茶总部信息</li>
                    </ul>
                </div>
                        ...
                        <div class="col-lg-12 col-sm-12 col-xs-12">
                            <div class="widget">
                                <div class="widget-header bordered-bottom bordered-blue">
                                    <span class="widget-caption">新增搞茶总部</span>
                                </div>
                                <div class="widget-body">
                                    <div id="horizontal-form">
                                        <form class="form-horizontal" role="form" action="" enctype="multipart/form-data" method="post">
                                            <div class="form-group">
                                                <label for="group_id" class="col-sm-2 control-label no-padding-right">搞茶描述</label>
                                                <div class="col-sm-6">
