<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"D:\wwwroot\sysnaica\wwwroot\agaocha\public/../application/admin\view\successful\add.htm";i:1533795185;s:83:"D:\wwwroot\sysnaica\wwwroot\agaocha\public/../application/admin\view\common\top.htm";i:1533881065;s:84:"D:\wwwroot\sysnaica\wwwroot\agaocha\public/../application/admin\view\common\left.htm";i:1533795181;}*/ ?>
<!DOCTYPE html>
<html><head>
	<meta charset="utf-8">
    <title>添加链接</title>
                        ...
                        <div class="col-lg-12 col-sm-12 col-xs-12">
                            <div class="widget">
                                <div class="widget-header bordered-bottom bordered-blue">
                                    <span class="widget-caption">新增案例</span>
                                </div>
                                <div class="widget-body">
                                    <div id="horizontal-form">
                                        <form class="form-horizontal" role="form" action="" method="post">
                                            ...
                                            <div class="form-group">
                                                <label for="content" class="col-sm-2 control-label no-padding-right">案例内容</label>
                                                <div class="col-sm-6">
