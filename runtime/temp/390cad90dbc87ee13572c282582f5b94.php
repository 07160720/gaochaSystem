<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:90:"D:\wwwroot\sysnaica\wwwroot\agaocha\public/../application/admin\view\headquarters\edit.htm";i:1533795182;s:83:"D:\wwwroot\sysnaica\wwwroot\agaocha\public/../application/admin\view\common\top.htm";i:1533795181;s:84:"D:\wwwroot\sysnaica\wwwroot\agaocha\public/../application/admin\view\common\left.htm";i:1533795181;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
    <title>编辑文章</title>
            ...
            <div class="page-content">
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo url('headquarters/lst'); ?>">搞茶信息管理</a>
                        </li>
                        <li class="active">修改搞茶信息</li>
                    </ul>
                </div>
                <div class="page-body">
                        ...
                        <div class="col-lg-12 col-sm-12 col-xs-12">
                            <div class="widget">
                                <div class="widget-header bordered-bottom bordered-blue">
                                    <span class="widget-caption">修改搞茶</span>
                                </div>
                                <div class="widget-body">
                                    <div id="horizontal-form">
                                        <form class="form-horizontal" role="form" action="" method="post">
                                            <input type="hidden" name="id" value="<?php echo $headquarters['id']; ?>">
                                            <div class="form-group">
                                                <label for="desc" class="col-sm-2 control-label no-padding-right">搞茶名称</label>
                                                <div class="col-sm-6">
                                                    <input class="form-control" id="desc" placeholder="" name="desc" value="<?php echo $headquarters['desc']; ?>"  type="text">
                                                </div>
