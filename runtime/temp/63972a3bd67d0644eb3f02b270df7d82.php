<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"D:\wwwroot\sysnaica\wwwroot\agaocha\public/../application/admin\view\process\edit.htm";i:1533795184;s:83:"D:\wwwroot\sysnaica\wwwroot\agaocha\public/../application/admin\view\common\top.htm";i:1533881065;s:84:"D:\wwwroot\sysnaica\wwwroot\agaocha\public/../application/admin\view\common\left.htm";i:1533795181;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
    <title>编辑文章</title>
            ...
            <div class="page-content">
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo url('process/lst'); ?>">加盟流程管理</a>
                        </li>
                        <li class="active">修改加盟流程信息</li>
                    </ul>
                </div>
                <div class="page-body">
                        ...
                        <div class="col-lg-12 col-sm-12 col-xs-12">
                            <div class="widget">
                                <div class="widget-header bordered-bottom bordered-blue">
                                    <span class="widget-caption">修改加盟流程</span>
                                </div>
                                    ...
                                    <div id="horizontal-form">
                                        <form class="form-horizontal" role="form" action="" method="post">
                                            ...
                                            <div class="form-group">
                                                <label for="process" class="col-sm-2 control-label no-padding-right">流程名称</label>
                                                <div class="col-sm-6">
                                                    <input class="form-control" id="process" placeholder="" name="process" value="<?php echo $process['process']; ?>"  type="text">
                                                </div>
