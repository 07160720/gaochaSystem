<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"D:\PhpStudy\PHPTutorial\WWW\agaocha\public/../application/admin\view\join\lst.htm";i:1533900334;s:83:"D:\PhpStudy\PHPTutorial\WWW\agaocha\public/../application/admin\view\common\top.htm";i:1533900335;s:84:"D:\PhpStudy\PHPTutorial\WWW\agaocha\public/../application/admin\view\common\left.htm";i:1533900335;}*/ ?>
<!DOCTYPE html>
<html><head>
	<meta charset="utf-8">
    <title>链接列表</title>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">加盟搞茶列表</li>
                    </ul>
                </div>
                <div class="page-body">

<!--                     <button type="button" tooltip="添加加盟" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('join/add'); ?>'"> <i class="fa fa-plus"></i> Add
                    </button> -->
                    <div class="row">
                                        ...
                                        <table class="table table-bordered table-hover">
                                            <thead class="">
                                                <tr>
                                                    ...
                                                    <th class="text-center" width="10%">加盟姓名</th>
                                                    <th class="text-center">加盟手机号码</th>
                                                    <th class="text-center">加盟地址</th>
                                                    <th class="text-center">加盟留言</th>
                                                    <th class="text-center">留言的时间</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center"><?php echo $vo['phonenumber']; ?></td>
                                                    <td align="center"><?php echo $vo['address']; ?></td>
                                                    <td align="center"><?php echo $vo['message']; ?></td>
                                                    <td align="center"><?php echo date("Y-m-d H:m:s",$vo['time']); ?></td>
                                                    <td align="center">
<!--                                                         <a href="<?php echo url('join/edit',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                                            <i class="fa fa-edit"></i> 编辑
                                                        </a> -->
                                                        <a href="#" onClick="warning('确实要删除吗', '<?php echo url('join/del',array('id'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny">
