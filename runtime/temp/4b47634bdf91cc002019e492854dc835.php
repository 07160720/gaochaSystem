<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"D:\PhpStudy\PHPTutorial\WWW\agaocha\public/../application/admin\view\headquarters\lst.htm";i:1533900335;s:83:"D:\PhpStudy\PHPTutorial\WWW\agaocha\public/../application/admin\view\common\top.htm";i:1533900335;s:84:"D:\PhpStudy\PHPTutorial\WWW\agaocha\public/../application/admin\view\common\left.htm";i:1533900335;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
            ...
            <div class="page-content">
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">搞茶总部管理</li>
                    </ul>
                </div>
                <div class="page-body">
                    <button type="button" tooltip="添加文章" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('headquarters/add'); ?>'"> <i class="fa fa-plus"></i> Add
                    </button>
                    <div class="row">
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <a href="<?php echo url('headquarters/edit',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                                            <i class="fa fa-edit"></i> 编辑
                                                        </a>
                                                        <a href="#" onClick="warning('确实要删除吗', '<?php echo url('headquarters/del',array('id'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny">
