<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"D:\wwwroot\sysnaica\wwwroot\agaocha\public/../application/admin\view\news\edit.htm";i:1533893081;s:83:"D:\wwwroot\sysnaica\wwwroot\agaocha\public/../application/admin\view\common\top.htm";i:1533881065;s:84:"D:\wwwroot\sysnaica\wwwroot\agaocha\public/../application/admin\view\common\left.htm";i:1533795181;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
    <title>编辑链接</title>
            ...
            <div class="page-content">
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo url('news/lst'); ?>">新闻动态管理</a>
                        </li>
                        <li class="active">修改新闻动态</li>
                    </ul>
                </div>
                <div class="page-body">
                                    ...
                                    <div id="horizontal-form">
                                        <form class="form-horizontal" role="form" action="" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" id="title" placeholder="" name="title" value="<?php echo $News['title']; ?>" type="text">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" id="keywords" placeholder="使用,隔开关键词" value="<?php echo $News['keywords']; ?>" name="keywords"  type="text">
                                                </div>
                                                <p class="help-block col-sm-4 red">* 必填</p>
                                            </div>

                                            <div class="form-group">
                                                <label for="desc" class="col-sm-2 control-label no-padding-right">新闻描述</label>
                                                <div class="col-sm-6">
                                                    <input class="form-control" id="desc" placeholder="" name="desc" value="<?php echo $News['desc']; ?>"  type="text">
                                                </div>
                                                <p class="help-block col-sm-4 red">* 必填</p>
                                            </div>  

                                            <div class="form-group">
                                                <label for="username"  required="" class="col-sm-2 control-label no-padding-right">新闻内容</label>
                                                <div class="col-sm-6">
